...
export const aboutParagraphs: LocalizedText[] = [
  {
    ja: "医用光学と生体計測を基盤に、非侵襲的な血流評価と末梢微小循環モニタリングに取り組んでいます。スペックルイメージングを起点として、SCOS、DCS、NIRSなどの光計測手法を用いながら、計測原理の理解から応用展開までを一貫して進めています。",
  ...
  {
    ja: "現在は、SCOSの深さ評価、血流マッピング、出血性ショックモデルへの応用など、基礎から応用へとつながる研究テーマを段階的に発展させています。",
...
export const aboutDetails: DetailItem[] = [
  ...
  },
  {
    ...
    value: {
      ja: [
        "明治大学理工学部電気電子生命学科（生命理工学専攻）卒業",
        "明治大学大学院理工学研究科電気工学専攻（博士前期課程）修了",
        "筑波大学大学院理工情報生命学術院システム情報工学研究群（博士後期課程）"
      ].join("\n"),
      en: [
