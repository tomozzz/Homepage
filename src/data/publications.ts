...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    tags: ["SCOS", "Muscle blood flow", "Conference proceeding"],
    type: {
      ja: "国際会議プロシーディング",
      en: "Conference proceeding"
    }
  },
  {
    ...
    authors:
      "Tomoya Yamamoto, Mikie Nakabayashi, Masashi Ichinose, and Yumie Ono",
    venue: "Optica Biophotonics Congress: Biomedical Optics 2024",
    year: "2024",
    sortDate: "2024-04-01",
    url: "https://opg.optica.org/abstract.cfm?uri=microscopy-2024-JS4A.17",
    tags: ["DCS", "Reactive hyperemia", "Conference proceeding"],
    type: {
      ja: "国際会議プロシーディング",
      en: "Conference proceeding"
    }
